...
export const Inputs = ({type, input, textarea, extra: {meta, customChecked, required, label, options, selectedOption}}) => {

  const extra = {meta, customChecked, required, label, options, selectedOption, textarea};
  ...
  switch (type) {
    ...
    default:
      return (
        <div>undefined type: <i>{type}</i></div>
      );
  }
};
