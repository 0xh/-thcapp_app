...
import {register, setReadMode, selectAll, unselectAll, selectRow, unselectRow} from '../../Actions/GridActions';
...
class DataGridContainer extends Component {
  ...
  render() {
    ...
    const {columns, source, readonly, loading, selectable, selectedRows, onAdd, defaultPageSize, pagination} = this.props;
