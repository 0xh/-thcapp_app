...
export class ValidationExamplesRoute extends Component {
  ...
  render() {
    return (
      <ContentContainer title="Forms Examples" backTo="/examples" id="validation-forms-examples">
        <DemoFormContainer title="System Data Types Validation Form" description="System Data Types Validation">
          <DataTypesForm />
        </DemoFormContainer>
      </ContentContainer>
    );
